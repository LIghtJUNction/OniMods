...
def main() -> None:
    helper = source("mods/oni_mcp/Tools/WorldEditorLogicGateRead.cs")
    grid = source("mods/oni_mcp/Tools/WorldEditorMapGrid.cs")
    cell = source("mods/oni_mcp/Tools/WorldEditorCellSnapshot.cs")
    details = source("mods/oni_mcp/Tools/WorldEditorConnectionDetails.cs")
    anchors = source("mods/oni_mcp/Tools/WorldEditorOverlayAnchors.cs")
