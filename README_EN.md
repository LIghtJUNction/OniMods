...
| `oni_mcp` Chinese docs | [mods/oni_mcp/README.md](mods/oni_mcp/README.md) | Installation, connection, and feature guide |
...
├── Directory.Build.props  # global MSBuild config, stores game DLL reference path
├── Cargo.toml             # onim CLI
