...
namespace OniMcp.Tools
{
    public static class GlobalControlSurfaceAuditTools
    {
        ...
        {
            yield return Covered("SpeedControlScreen", "pause_toggle", "TogglePause", "Pause/unpause the simulation", new[] { "game_control domain=speed action=time", "game_control domain=speed" }, new[] { "game_control domain=speed action=time" });
            yield return Covered("SpeedControlScreen", "speed_buttons", "CycleSpeed/SpeedUp/SlowDown", "Set normal/fast/ultra simulation speed", new[] { "game_control domain=speed action=time", "game_control domain=speed" }, new[] { "game_control domain=speed action=time" });
            ...
            yield return Covered("PauseScreen", "options", "", "Open options submenu; individual settings are user preference/client configuration", new[] { "game_control domain=ui uiDomain=action" }, new[] { "game_control domain=ui uiDomain=action" });
            ...
            yield return Covered("PauseScreen", "quit_desktopquit", "", "Quit current game to main menu or desktop, optionally saving first, with explicit confirmation", new[] { "game_control domain=speed action=time", "game_saves_list", "game_quit" }, new[] { "game_control domain=speed action=time", "game_saves_list" });
