    ...
    public static class UiControlTools
    {
        public static McpTool ControlUi()
        {
            return new McpTool
            {
                ...
                Description = "UI 聚合入口：domain=action/feedback。action 读取或触发安全 UI Action，feedback 创建通知/浮字/地图标记。",
                Parameters = new Dictionary<string, McpToolParameter>
                {
                    ...
                    ["action"] = new McpToolParameter { Type = "string", Description = "domain=action: list/trigger/open_management；domain=feedback: notification/popup/marker", Required = true },
