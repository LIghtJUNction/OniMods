    ...
    public static class MedicalTools
    {
        public static McpTool ListPatients()
        {
            return new McpTool
            {
                ...
                Description = "列出需要医疗关注的复制人：生命值、疾病、辐射/压力等需求、当前医疗床分配和可用治疗线索",
        ...
        public static McpTool ListClinics()
        {
            return new McpTool
            {
                ...
                Description = "列出医疗床/诊所及其治疗阈值、分配对象和优先级",
        ...
        public static McpTool ListDoctorStations()
        {
            return new McpTool
            {
                ...
                Description = "列出医生站/高级医生站、药品库存、可治疗疾病和当前可治疗患者",
                Parameters = RectParams(new Dictionary<string, McpToolParameter>
                {
        ...
        public static McpTool SetClinicThreshold()
        {
            return new McpTool
            {
                ...
                Tags = new List<string> { "medical", "clinic", "bed", "threshold", "care" },
                Description = "设置医疗床/诊所的治疗阈值百分比，对应 Medical Cot side screen slider",
        ...
        public static McpTool BatchSetClinicThreshold()
        {
            return new McpTool
            {
                ...
                Description = "按区域批量设置医疗床/诊所的治疗阈值百分比",
                Parameters = RectParams(new Dictionary<string, McpToolParameter>
                {
                    ["thresholdPercent"] = new McpToolParameter { Type = "number", Description = "治疗阈值百分比 0-100", Required = true },
        ...
        public static McpTool AssignMedicalBed()
        {
            return new McpTool
            {
                ...
                Description = "分配或清除医疗床/诊所患者，可同时设置治疗阈值",
                Parameters = LookupParams(new Dictionary<string, McpToolParameter>
                {
